...
const dataa2 =localStorage.getItem('valuee2')
      ...
      {mm1.map((ele) => {   
        return (
          <div className='container nonflex' style={{ margin: 'auto' }}>
            <div className="container" style={{ height: 'auto', }}>
              ...
              <div className="d-flex flex2s">
                <div>
              <h1 className='colorss mt-3' style={{fontSize:'21px',color:'#043263',fontFamily: 'Ubuntu, sans-serif',fontWeight:400}}>{ele.trip}</h1>

              {/* <hr style={{ width: "90%" }} /> */}
              <div style={{ textAlign: "justify", width: "90%" }}> <h3 className='colorss mt-5 mb-3' style={{fontSize:'21px',fontFamily: 'Ubuntu, sans-serif',color:'#043263'}}>Description</h3>
                <p style={{color: '#5e6d77', fontWeight: '300' , fontFamily: 'Nunito, sans-serif'}}>{ele.desc}</p>
              </div>
              {/* <hr style={{ width: "90%" }} /> */}
          ...
          <p>cofeee</p>
                ...
                <div style={{ width: "50%" }}>
                  <h3 className='my-3 colorss mt-5 mb-4' style={{fontSize:'21px',fontFamily: 'Ubuntu, sans-serif',color:'#043263'}}> Rules</h3>
                  <div style={{ display: "flex", justifyContent: "space-between",fontSize:'15px',color: '#5e6d77', fontWeight: '300' , fontFamily: 'Nunito, sans-serif' }}><p> Check In </p> <p>12:00 pm</p></div>
                  <div style={{ display: "flex", justifyContent: "space-between",fontSize:'15px',color: '#5e6d77', fontWeight: '300' , fontFamily: 'Nunito, sans-serif' }}><p> Check Out </p> <p>11:00 Am</p></div>
                ...
                const roomData =eles.room1.length;
                {
                  return (
                    ...
                    <div style={{ width: "90%", padding: "2px" }} key={i}>
                      <h1  className='colorss' style={{fontSize:'21px',fontFamily: 'Ubuntu, sans-serif',color:'#043263'}}>Rooms</h1>
                      ...
                      {eles.room1.map((room, i) => (
                        ...
                        <div key={i} className="direct" style={{ display: "flex", border: "0.1px solid #d0dbdb", justifyContent: "space-between", padding: "0", margin: "0" }}>
                          ...
                          <div className="mt-2 " style={{ display: "flex", flexDirection: "column", justifyContent: "center", alignItems: "center" }}> <h5 className='ms-2 colorss' style={{color:'#043263'}}> {room.roomtype}</h5>
  ...
  return null; // If the condition is not met, you can return null or an empty fragment
                          ...
                          <div style={{ display: "flex", justifyContent: 'center', alignItems: "center", flexDirection: 'column' }}><Link to={`/rooms/${room.id}?roomValue=${localStorage.getItem(`valuee${i}`)}`} onClick={()=>Scrooltop()}><button className='btn btn-large btn-danger mt-4 me-3 ' >Show more</button></Link></div>
            ...
            <div className='bg-white hideing' style={{ width: "400px" , display:'none' }}>
              ...
              <div className='fs-5 mt-5' style={{ display: "flex", height:"100px", flexDirection: "column", justifyContent: "center", alignItems: "center", border: "1px solid #66cccc" }}>
                <div style={{ display: "flex" }}><div><i style={{ color: "#66cccc", fontWeight: "600" }} class="fa-solid fa-envelope mt-1 me-2"></i></div><div style={{ fontWeight: "500" }} className='colorss'> Atraski@Gmail.com</div></div>
                <div style={{ display: "flex" }}> <div><i style={{ color: "#66cccc", fontWeight: "600" }} class="fa-solid fa-phone mt-1 me-5"></i></div><div style={{ fontWeight: "500" }} className='me-3 colorss' >8898734567</div></div>
              </div>
            </div>
